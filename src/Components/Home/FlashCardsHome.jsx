...
import FlashCardsDetails from '../All FlashCards/Details';
import MyFlashCards from '../All FlashCards/Flashcards';
import CreateFlashCards from './FlashCards';

const FlashCardsHome = () => {
  return (
    <div className=" bg-red-50 min-h-screen p-1 dark:bg-[#0d1117]"style={{background:"teal"}}>
